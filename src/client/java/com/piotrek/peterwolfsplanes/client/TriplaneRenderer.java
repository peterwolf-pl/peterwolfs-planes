...
public class TriplaneRenderer extends EntityRenderer<PlaneEntity, PlaneRenderState> {
	private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(PeterwolfsPlanesMod.MOD_ID, "textures/entity/red_plane.png");
	private final TriplaneModel model;

	public TriplaneRenderer(EntityRendererProvider.Context context) {
		super(context);
		this.shadowRadius = 0.8F;
		this.model = new TriplaneModel(context.bakeLayer(PeterwolfsPlanesClient.TRIPLANE_MODEL_LAYER));
	}
