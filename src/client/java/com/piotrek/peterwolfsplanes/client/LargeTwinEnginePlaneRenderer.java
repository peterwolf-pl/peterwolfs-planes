...
public class LargeTwinEnginePlaneRenderer extends EntityRenderer<PlaneEntity, PlaneRenderState> {
	private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(PeterwolfsPlanesMod.MOD_ID, "textures/entity/large_plane.png");
	private final LargeTwinEnginePlaneModel model;

	public LargeTwinEnginePlaneRenderer(EntityRendererProvider.Context context) {
		super(context);
		this.shadowRadius = 1.0F; // Larger shadow
		this.model = new LargeTwinEnginePlaneModel(context.bakeLayer(PeterwolfsPlanesClient.LARGE_TWIN_ENGINE_PLANE_MODEL_LAYER));
	}
