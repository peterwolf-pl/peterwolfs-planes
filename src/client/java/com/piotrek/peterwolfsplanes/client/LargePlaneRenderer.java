...
public class LargePlaneRenderer extends EntityRenderer<PlaneEntity, PlaneRenderState> {
	...
	private final LargePlaneModel model;

	public LargePlaneRenderer(EntityRendererProvider.Context context) {
		super(context);
		this.shadowRadius = 1.0F; // Larger shadow
		this.model = new LargePlaneModel(context.bakeLayer(PeterwolfsPlanesClient.LARGE_PLANE_MODEL_LAYER));
	}
