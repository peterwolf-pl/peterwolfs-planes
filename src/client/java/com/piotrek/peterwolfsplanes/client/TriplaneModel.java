...
public class TriplaneModel extends PlaneModel {
	public TriplaneModel(ModelPart root) {
		super(root);
	}
	...
	public static LayerDefinition createLayerDefinition() {
		...
		body.addOrReplaceChild("lower_wing",
			CubeListBuilder.create()
				.texOffs(0, 68)
				.addBox(-27.0F, 6.0F, -6.0F, 54.0F, 2.0F, 12.0F),
			PartPose.ZERO
		);

		// Middle wing (reusing lower wing's texture offset, split at the cockpit area)
		body.addOrReplaceChild("middle_wing",
			CubeListBuilder.create()
				.texOffs(0, 68)
				.addBox(-27.0F, -7.0F, -6.0F, 21.0F, 2.0F, 12.0F)
				.texOffs(0, 68)
				.addBox(6.0F, -7.0F, -6.0F, 21.0F, 2.0F, 12.0F),
			PartPose.ZERO
		);
		...
		body.addOrReplaceChild("upper_wing",
			CubeListBuilder.create()
				.texOffs(0, 84)
				.addBox(-31.0F, -20.0F, -6.0F, 62.0F, 2.0F, 12.0F),
			PartPose.ZERO
		);
		...
		body.addOrReplaceChild("left_support_1",
			CubeListBuilder.create()
				.texOffs(190, 68)
				.addBox(-21.0F, -18.0F, -4.0F, 1.0F, 24.0F, 1.0F),
			PartPose.ZERO
		);
		...
		body.addOrReplaceChild("right_support_1",
			CubeListBuilder.create()
				.texOffs(194, 68)
				.addBox(20.0F, -18.0F, -4.0F, 1.0F, 24.0F, 1.0F),
			PartPose.ZERO
		);
